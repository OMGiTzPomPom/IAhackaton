...
<template>
  <div class="text-center p-8">
    <h2 class="text-xl font-semibold mb-2 text-gray-600">Question 24</h2>
    <h1 class="text-2xl font-bold mb-6">Tu veux trouver une idée cadeau. Que choisis-tu ?</h1>
    <button @click="choose(40, 'Demander à une IA')" class="btn-blue">Demander à une IA</button>
    <button @click="choose(1, 'Demander à un ami')" class="btn-blue ml-4">Demander à un ami</button>
  </div>
  ...
  <div v-if="answered" class="text-center p-8 max-w-2xl mx-auto">
    ...
    <p class="mb-6 text-gray-700">
      Demander à un humain est plus social… et plus écologique.
    </p>
...
function choose(energy, option) {
  ...
  const otherEnergy = energy === 40 ? 1 : 40
