...
<template>
  <div class="text-center p-8">
    <h2 class="text-xl font-semibold mb-2 text-gray-600">Question 31</h2>
    <h1 class="text-2xl font-bold mb-6">Tu veux créer un quiz. Quelle méthode préfères-tu ?</h1>
    <button @click="choose(80, 'Utiliser une IA')" class="btn-blue">Utiliser une IA</button>
    <button @click="choose(9, 'Le faire toi-même')" class="btn-blue ml-4">Le faire toi-même</button>
  </div>
  ...
  <div v-if="answered" class="text-center p-8 max-w-2xl mx-auto">
    ...
    <p class="mb-6 text-gray-700">
      Créer un quiz peut être amusant… et écologique sans IA.
    </p>
...
function choose(energy, option) {
  ...
  const otherEnergy = energy === 80 ? 9 : 80
